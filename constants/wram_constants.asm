...
; wDailyFlags3::
	const DAILYFLAGS3_FALKNER_REMATCH_F
	const DAILYFLAGS3_BUGSY_REMATCH_F
	const DAILYFLAGS3_WHITNEY_REMATCH_F
	const DAILYFLAGS3_MORTY_REMATCH_F
	const DAILYFLAGS3_CHUCK_REMATCH_F
	const DAILYFLAGS3_JASMINE_REMATCH_F
	const DAILYFLAGS3_PRYCE_REMATCH_F
	const DAILYFLAGS3_CLAIR_REMATCH_F
; wDailyFlags3::
	const DAILYFLAGS4_BROCK_REMATCH_F
	const DAILYFLAGS4_MISTY_REMATCH_F
	const DAILYFLAGS4_LT_SURGE_REMATCH_F
	const DAILYFLAGS4_ERIKA_REMATCH_F
	const DAILYFLAGS4_JANINE_REMATCH_F
	const DAILYFLAGS4_SABRINA_REMATCH_F
	const DAILYFLAGS4_BLAINE_REMATCH_F
	const DAILYFLAGS4_BLUE_REMATCH_F
; wSwarmFlags::
	const_def
