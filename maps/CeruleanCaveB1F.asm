...
CeruleanCaveB1F_MapEvents:
	...
	def_object_events
	object_event 29, 14, SPRITE_MEWTWO, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, Mewtwo, EVENT_CERULEANCAVEB1F_MEWTWO
	...
	object_event 29, 14, SPRITE_RED, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, CeruleanCaveRed, EVENT_CERULEAN_CAVE_RED
