...
; entries correspond to NPCTRADE_* constants
	...
	npctrade TRADE_DIALOGSET_GIRL,      CHANSEY,    AERODACTYL, "AEROY@@@@@@", $96, $66, GOLD_BERRY,   26491, "KIM@@@@@@@@", TRADE_GENDER_EITHER ;NO LONGER USED
	npctrade TRADE_DIALOGSET_COLLECTOR, DUGTRIO,    MAGNETON,   "MAGGIE@@@@@", $96, $66, METAL_COAT,   50082, "FOREST@@@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_COLLECTOR, AERODACTYL, CHANSEY,    "JOY@@@@@@@@", $96, $66, GOLD_BERRY,   06669, "GIANCARLO@@", TRADE_GENDER_EITHER
