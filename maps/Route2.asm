...
Route2_MapEvents:
	...
	warp_event  1, 7, ROUTE_2_VIRIDIAN_FOREST_GATE_NORTH, 1
	warp_event  2, 7, ROUTE_2_VIRIDIAN_FOREST_GATE_NORTH, 2
	warp_event  5, 31, ROUTE_2_VIRIDIAN_FOREST_GATE_SOUTH, 3
	...
	bg_event  7, 33, BGEVENT_READ, Route2ViridianForestSign
	...
	object_event 18, 43, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route2FruitTree, -1
