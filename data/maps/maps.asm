...
MapGroup_Dungeons:
	...
	map SafariZoneCenter, TILESET_SAFARI_ZONE, ROUTE, LANDMARK_SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
	map SafariZoneNorth, TILESET_SAFARI_ZONE, ROUTE, LANDMARK_SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
	map SafariZoneEast, TILESET_SAFARI_ZONE, ROUTE, LANDMARK_SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
	map SafariZoneWest, TILESET_SAFARI_ZONE, ROUTE, LANDMARK_SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
	map CeruleanCave1F, TILESET_CAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
	map CeruleanCave2F, TILESET_CAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
	map CeruleanCaveB1F, TILESET_CAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
	map CinnabarVolcano1F, TILESET_CAVE_CINNABAR, CAVE, LANDMARK_CINNABAR_VOLCANO, MUSIC_MT_MOON, TRUE, PALETTE_DAY, FISHGROUP_LAKE
	map CinnabarVolcano2F, TILESET_CAVE_CINNABAR, CAVE, LANDMARK_CINNABAR_VOLCANO, MUSIC_MT_MOON, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map CinnabarVolcanoB1F, TILESET_CAVE_CINNABAR, CAVE, LANDMARK_CINNABAR_VOLCANO, MUSIC_MT_MOON, TRUE, PALETTE_DAY, FISHGROUP_WHIRL_ISLANDS
	map CinnabarVolcanoItemRooms, TILESET_CAVE_CINNABAR, CAVE, LANDMARK_CINNABAR_VOLCANO, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map SeafoamIslands1F, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, TRUE, PALETTE_AUTO, FISHGROUP_LAKE
	map SeafoamIslandsB1F, TILESET_ICE_PATH, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map SeafoamIslandsB2F, TILESET_ICE_PATH, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map SeafoamIslandsB3F, TILESET_ICE_PATH, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map SeafoamIslandsB4F, TILESET_ICE_PATH, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_REMORAID
	map PowerPlantB1F, TILESET_POWER_PLANT, DUNGEON, LANDMARK_POWER_PLANT, MUSIC_ROCKET_HIDEOUT, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map UndergroundKPF, TILESET_UNDERGROUND, GATE, LANDMARK_UNDERGROUND_PATH, MUSIC_MT_MOON, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map SafariZoneCenterHouse, TILESET_GAME_CORNER, INDOOR, LANDMARK_SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
	map SafariZoneNorthHouse, TILESET_GAME_CORNER, INDOOR, LANDMARK_SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
	map SafariZoneEastHouse, TILESET_GAME_CORNER, INDOOR, LANDMARK_SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SafariZoneWestHouse, TILESET_GAME_CORNER, INDOOR, LANDMARK_SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SafariZoneSecretHouse, TILESET_GAME_CORNER, INDOOR, LANDMARK_SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TestWarpRoom, TILESET_CAVE, INDOOR, LANDMARK_SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_NITE, FISHGROUP_SHORE ; FOR TESTING
...
MapGroup_Cinnabar:
	...
	map SeafoamGym, TILESET_CAVE, INDOOR, LANDMARK_SEAFOAM_ISLANDS, MUSIC_GYM, TRUE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Pewter:
	...
	map Museum1F, TILESET_MUSEUM, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Museum2F, TILESET_MUSEUM, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Lavender:
	...
	map Route8UndergroundPathEntrance, TILESET_GATE, GATE, LANDMARK_ROUTE_8, MUSIC_MT_MOON, FALSE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Celadon:
	...
	map Route7UndergroundPathEntrance, TILESET_GATE, GATE, LANDMARK_ROUTE_7, MUSIC_MT_MOON, FALSE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Viridian:
	...
	map Route2, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_2, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map Route2Gate, TILESET_GATE, GATE, LANDMARK_ROUTE_2, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map VictoryRoadGate, TILESET_GATE, GATE, LANDMARK_ROUTE_26, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route2ViridianForestGateNorth, TILESET_GATE, GATE, LANDMARK_ROUTE_2, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route2ViridianForestGateSouth, TILESET_GATE, GATE, LANDMARK_ROUTE_2, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianForest, TILESET_SAFARI_ZONE, ROUTE, LANDMARK_VIRIDIAN_FOREST, MUSIC_ROUTE_2, FALSE, PALETTE_AUTO, FISHGROUP_POND
...
MapGroup_Saffron:
	...
	map SilphCo2F, TILESET_FACILITY, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
