...
; wDailyFlags3
	const ENGINE_FALKNER_REMATCH
	const ENGINE_BUGSY_REMATCH
	const ENGINE_WHITNEY_REMATCH
	const ENGINE_MORTY_REMATCH
	const ENGINE_CHUCK_REMATCH
	const ENGINE_JASMINE_REMATCH
	const ENGINE_PRYCE_REMATCH
	const ENGINE_CLAIR_REMATCH
; wDailyFlags3::
	const ENGINE_BROCK_REMATCH
	const ENGINE_MISTY_REMATCH
	const ENGINE_LT_SURGE_REMATCH
	const ENGINE_ERIKA_REMATCH
	const ENGINE_JANINE_REMATCH
	const ENGINE_SABRINA_REMATCH
	const ENGINE_BLAINE_REMATCH
	const ENGINE_BLUE_REMATCH
; wSwarmFlags
