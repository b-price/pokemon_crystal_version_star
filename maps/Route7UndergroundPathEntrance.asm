...
Route7UndergroundPathEntrance_MapEvents:
	...
	def_object_events
	object_event  2,  4, SPRITE_BIKER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 2, TrainerBikerMick, EVENT_KPF_BIKERS
	object_event  5,  4, SPRITE_BIKER, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 2, TrainerBikerJebediah, EVENT_KPF_BIKERS
