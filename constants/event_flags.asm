...
; Johto story events
	...
	const EVENT_TALKED_TO_FOREST_GATE_MOVE_TUTOR ;new
...
; Kanto hidden items
	...
	const EVENT_ROUTE_2_HIDDEN_MAX_ETHER ; now unused
	const EVENT_ROUTE_2_HIDDEN_FULL_HEAL ; now unused
	const EVENT_ROUTE_2_HIDDEN_FULL_RESTORE ; now unused
	const EVENT_ROUTE_2_HIDDEN_REVIVE ; now unused
...
; new events
	const EVENT_SHOWED_WARDEN_GDAUGHTER_LEGEND_BIRD
	const EVENT_OPENED_SILPH_CO_2F
	const EVENT_CINNABARVOLCANO2F_MOLTRES
	const EVENT_FOUGHT_MOLTRES
	const EVENT_POWERPLANTB1F_ZAPDOS
	const EVENT_FOUGHT_ZAPDOS
	const EVENT_POWER_PLANT_B1F_ELECTRODE_1
	const EVENT_POWER_PLANT_B1F_ELECTRODE_2
	const EVENT_POWER_PLANT_B1F_ELECTRODE_3
	const EVENT_POWER_PLANT_B1F_VOLTORB_1
	const EVENT_POWER_PLANT_B1F_VOLTORB_2
	const EVENT_POWER_PLANT_B1F_VOLTORB_3
	const EVENT_SEAFOAM_ISLANDS_B4F_ARTICUNO
	...
	const EVENT_VIRIDIAN_FOREST_MEW
	const EVENT_FOUGHT_MEW
	const EVENT_GOT_POKE_FLUTE
	const EVENT_CERULEANCAVEB1F_MEWTWO
	const EVENT_FOUGHT_MEWTWO
	const EVENT_USED_SECRET_KEY
	const EVENT_TALKED_TO_SECRET_HOUSE_GUY
	const EVENT_SILPH_CO_1F_OFFICER_1
	const EVENT_SILPH_CO_1F_OFFICER_2
	...
	const EVENT_BROCK_IN_GYM
	const EVENT_MISTY_IN_GYM
	const EVENT_LT_SURGE_IN_GYM
	const EVENT_ERIKA_IN_GYM
	const EVENT_SABRINA_IN_GYM
	const EVENT_JANINE_IN_GYM
	const EVENT_BLAINE_IN_GYM
	const EVENT_BLUE_IN_GYM
	const EVENT_FALKNER_IN_GYM
	const EVENT_BUGSY_IN_GYM
	const EVENT_WHITNEY_IN_GYM
	const EVENT_MORTY_IN_GYM
	const EVENT_CHUCK_IN_GYM
	const EVENT_JASMINE_IN_GYM
	const EVENT_PRYCE_IN_GYM
	const EVENT_CLAIR_IN_GYM
	const EVENT_FIGHTINGDOJO_KIYOANDCO
	const EVENT_FIGHTINGDOJO_BLACKBELT
	const EVENT_VIRIDIAN_GYM_GUIDE
	const EVENT_ROUTE_10_OFFICER
	const EVENT_KPF_BIKERS
	const EVENT_CERULEAN_CAVE_RED
	const EVENT_RUINED_MISTYS_DATE
	
;new itemballs
	const EVENT_CINNABAR_VOLCANO_1F_BURN_HEAL
	const EVENT_CINNABAR_VOLCANO_1F_ESCAPE_ROPE
	const EVENT_CINNABAR_VOLCANO_B1F_FIRE_STONE
	const EVENT_CINNABAR_VOLCANO_B1F_REVIVE
	const EVENT_CINNABAR_VOLCANO_B1F_NUGGET
	const EVENT_CINNABAR_VOLCANO_B1F_MAX_ELIXER
	const EVENT_CINNABAR_VOLCANO_B1F_MAX_REVIVE
	const EVENT_CINNABAR_VOLCANO_ITEM_TM_FLAMETHROWER
	const EVENT_CINNABAR_VOLCANO_ITEM_MAX_REVIVE
	const EVENT_CINNABAR_VOLCANO_ITEM_DOME_FOSSIL
	const EVENT_CINNABAR_VOLCANO_ITEM_SUN_STONE
	const EVENT_SAFARI_ZONE_CENTER_NUGGET
	const EVENT_SAFARI_ZONE_EAST_CARBOS
	const EVENT_SAFARI_ZONE_EAST_MAX_REVIVE
	const EVENT_SAFARI_ZONE_EAST_MAX_ETHER
	const EVENT_SAFARI_ZONE_EAST_ULTRA_BALL
	const EVENT_SAFARI_ZONE_NORTH_TM_SNORE
	const EVENT_SAFARI_ZONE_NORTH_RARE_CANDY
	const EVENT_SAFARI_ZONE_NORTH_NUGGET
	const EVENT_SAFARI_ZONE_NORTH_MAX_REVIVE
	const EVENT_SAFARI_ZONE_WEST_TM_SLEEP_TALK
	const EVENT_SAFARI_ZONE_WEST_RARE_CANDY
	const EVENT_SAFARI_ZONE_WEST_NUGGET
	const EVENT_SAFARI_ZONE_WEST_MAX_ELIXER
	const EVENT_SAFARI_ZONE_NORTH_HOUSE_TM_REST
	const EVENT_SAFARI_ZONE_WEST_HOUSE_SCOPE_LENS
	const EVENT_POWER_PLANT_B1F_TM_THUNDERBOLT
	const EVENT_POWER_PLANT_B1F_ULTRA_BALL
	const EVENT_POWER_PLANT_B1F_THUNDERSTONE
	const EVENT_POWER_PLANT_B1F_METAL_COAT
	const EVENT_POWER_PLANT_B1F_PARLYZ_HEAL
	const EVENT_POWER_PLANT_B1F_ESCAPE_ROPE
	const EVENT_SEAFOAM_ISLANDS_B1F_ICE_HEAL
	const EVENT_SEAFOAM_ISLANDS_B1F_WATER_STONE
	const EVENT_SEAFOAM_ISLANDS_B2F_KINGS_ROCK
	const EVENT_SEAFOAM_ISLANDS_B3F_MOON_STONE
	const EVENT_SEAFOAM_ISLANDS_B3F_TM_ICE_BEAM
	const EVENT_SEAFOAM_ISLANDS_B3F_MAX_POTION
	const EVENT_SEAFOAM_ISLANDS_B4F_HELIX_FOSSIL
	const EVENT_SEAFOAM_ISLANDS_B4F_MAX_REVIVE
	const EVENT_VIRIDIAN_FOREST_TM_FURY_CUTTER
	const EVENT_VIRIDIAN_FOREST_ANTIDOTE
	const EVENT_VIRIDIAN_FOREST_ELIXER
	const EVENT_VIRIDIAN_FOREST_LEAF_STONE
	const EVENT_CERULEAN_CAVE_1F_MAX_ELIXER
	const EVENT_CERULEAN_CAVE_1F_NUGGET
	const EVENT_CERULEAN_CAVE_1F_MAX_REVIVE
	const EVENT_CERULEAN_CAVE_2F_TM_THUNDER
	const EVENT_CERULEAN_CAVE_2F_TM_BLIZZARD
	const EVENT_CERULEAN_CAVE_2F_TM_FIRE_BLAST
	const EVENT_CERULEAN_CAVE_B1F_TM_HYPER_BEAM
	const EVENT_CERULEAN_CAVE_B1F_OLD_AMBER
	const EVENT_CERULEAN_CAVE_B1F_MAX_ELIXER
	const EVENT_UNDERGROUND_KPF_NUGGET
	const EVENT_UNDERGROUND_KPF_X_ATTACK
	const EVENT_UNDERGROUND_KPF_POISONBARB
	const EVENT_UNDERGROUND_KPF_SECRET_KEY
	const EVENT_TEST_WARP_ROOM_MASTER_BALL
	
;new hidden items
	const EVENT_CINNABAR_VOLCANO_1F_HIDDEN_PP_UP
	const EVENT_CINNABAR_VOLCANO_2F_HIDDEN_CHARCOAL
	const EVENT_CINNABAR_VOLCANO_B1F_HIDDEN_MAX_ETHER
	const EVENT_CINNABAR_VOLCANO_B1F_HIDDEN_PP_UP
	const EVENT_CINNABAR_VOLCANO_B1F_HIDDEN_RARE_CANDY
	const EVENT_CINNABAR_VOLCANO_B1F_HIDDEN_FULL_RESTORE
	const EVENT_CINNABAR_VOLCANO_B1F_HIDDEN_STARDUST
	const EVENT_CINNABAR_VOLCANO_ITEM_HIDDEN_PP_UP
	const EVENT_CINNABAR_VOLCANO_ITEM_HIDDEN_MAX_ETHER
	const EVENT_CINNABAR_VOLCANO_ITEM_HIDDEN_ETHER
	const EVENT_SAFARI_ZONE_CENTER_HIDDEN_PP_UP
	const EVENT_SAFARI_ZONE_EAST_HIDDEN_PP_UP
	const EVENT_SAFARI_ZONE_NORTH_HIDDEN_PP_UP
	const EVENT_SAFARI_ZONE_WEST_HIDDEN_PP_UP
	const EVENT_SAFARI_ZONE_CENTER_HOUSE_HIDDEN_RARE_CANDY
	const EVENT_SAFARI_ZONE_EAST_HOUSE_HIDDEN_LEFTOVERS
	const EVENT_POWER_PLANT_B1F_HIDDEN_MAGNET
	const EVENT_POWER_PLANT_B1F_HIDDEN_PP_UP
	const EVENT_POWER_PLANT_B1F_HIDDEN_MAX_ELIXER
	const EVENT_POWER_PLANT_B1F_HIDDEN_MAX_ETHER
	const EVENT_SEAFOAM_ISLANDS_1F_HIDDEN_RARE_CANDY
	const EVENT_SEAFOAM_ISLANDS_B1F_HIDDEN_MAX_REVIVE
	const EVENT_SEAFOAM_ISLANDS_B1F_HIDDEN_MAX_ETHER
	const EVENT_SEAFOAM_ISLANDS_B1F_HIDDEN_CALCIUM
	const EVENT_SEAFOAM_ISLANDS_B2F_HIDDEN_NEVERMELTICE
	const EVENT_SEAFOAM_ISLANDS_B2F_HIDDEN_ELIXER
	const EVENT_SEAFOAM_ISLANDS_B3F_HIDDEN_HP_UP
	const EVENT_SEAFOAM_ISLANDS_B3F_HIDDEN_PP_UP
	const EVENT_SEAFOAM_ISLANDS_B3F_HIDDEN_STAR_PIECE
	const EVENT_SEAFOAM_ISLANDS_B4F_HIDDEN_BIG_PEARL
	const EVENT_SEAFOAM_ISLANDS_B4F_HIDDEN_MYSTIC_WATER
	const EVENT_SEAFOAM_ISLANDS_B4F_HIDDEN_REVIVE
	const EVENT_VIRIDIAN_FOREST_HIDDEN_SILVER_POWDER
	const EVENT_VIRIDIAN_FOREST_HIDDEN_GOLD_BERRY
	const EVENT_VIRIDIAN_FOREST_HIDDEN_MYSTERYBERRY
	const EVENT_VIRIDIAN_FOREST_HIDDEN_BITTER_BERRY
	const EVENT_CERULEAN_CAVE_1F_HIDDEN_RARE_CANDY
	const EVENT_CERULEAN_CAVE_1F_HIDDEN_STAR_PIECE
	const EVENT_CERULEAN_CAVE_2F_HIDDEN_PP_UP
	const EVENT_CERULEAN_CAVE_2F_HIDDEN_NUGGET
	const EVENT_CERULEAN_CAVE_2F_HIDDEN_MAX_ELIXER
	const EVENT_CERULEAN_CAVE_B1F_HIDDEN_PP_UP
	const EVENT_CERULEAN_CAVE_B1F_HIDDEN_TWISTEDSPOON
	const EVENT_TEST_WARP_ROOM_ITEM_2 ;TEST
...
; Blackbelt
	const EVENT_BEAT_BLACKBELT_KENSUKE ;RENAMED FROM KENJI2
	...
	const EVENT_BEAT_BLACKBELT_HIROSHI ;RENAMED FROM KENJI2
...
; new trainers
	const EVENT_BEAT_BURGLAR_RAUL
	const EVENT_BEAT_BURGLAR_TOSE
	const EVENT_BEAT_BOARDER_BINX
	const EVENT_BEAT_BOARDER_SHORTY
	const EVENT_BEAT_SKIER_MIAMI
	const EVENT_BEAT_BUG_CATCHER_SILIAS
	const EVENT_BEAT_BUG_CATCHER_TERRY
	const EVENT_BEAT_BUG_CATCHER_SAL
	const EVENT_BEAT_POKEMANIAC_MAURICE
	const EVENT_BEAT_BLACKBELT_SATORU
	const EVENT_BEAT_BLACKBELT_TAKASHI
	const EVENT_BEAT_BLACKBELT_KIYO2
	const EVENT_BEAT_BIKER_MICK
	const EVENT_BEAT_BIKER_JEBEDIAH
	const EVENT_BEAT_BIKER_LIAM
	const EVENT_BEAT_BIKER_LEE
	const EVENT_BEAT_BIKER_JESSE
	const EVENT_BEAT_BIKER_HORACE
	const EVENT_BEAT_BIKER_ROBERTO
	const EVENT_BEAT_BIKER_DIGBY
	const EVENT_BEAT_BIKER_NIC
	const EVENT_BEAT_TWINS_JAZ_AND_TAZ
	const EVENT_BEAT_POKEFAN_M_DWIGHT
	const EVENT_BEAT_LASS_TRISH
	const EVENT_BEAT_SUPER_NERD_RUSS
	const EVENT_BEAT_SUPER_NERD_NORTON
	const EVENT_BEAT_FISHER_NIKOLAI
	const EVENT_BEAT_LASS_NATALIE
	const EVENT_BEAT_POKEFANF_JANET
	const EVENT_BEAT_BIKER_RISHI
	const EVENT_BEAT_BIKER_SAUL
	const EVENT_BEAT_BIKER_BRETT
	const EVENT_BEAT_BIKER_ANTON
	const EVENT_BEAT_POKEFANM_PIERRE
	const EVENT_BEAT_FISHER_KEANU
	const EVENT_BEAT_FISHER_HUNG
	const EVENT_BEAT_FISHER_JAZ
	const EVENT_BEAT_FISHER_MANDO
	const EVENT_BEAT_COOLTRAINER_F_DOMINO
	const EVENT_BEAT_COOLTRAINERF_SALLY
	const EVENT_BEAT_COOLTRAINERF_WINONA
	const EVENT_BEAT_COOLTRAINERF_MARIAN
	const EVENT_BEAT_JUGGLER_KORY
	const EVENT_BEAT_JUGGLER_KOSMO
